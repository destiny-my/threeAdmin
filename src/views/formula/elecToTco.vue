  ...
  <div class="container">
      ...
      <form class="layui-form" action="">
          <div class="layui-form-item">
              <label class="layui-form-label" style="margin-left: 40px;margin-right: 10px;">区域</label>
              ...
              <label class="layui-form-label" style="margin-left: 70px;margin-right: 10px;">消耗电量</label>
