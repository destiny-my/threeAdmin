<template xmlns="http://www.w3.org/1999/html">
  ...
  <div class="container">
    <el-row class="running" :gutter="12">
      <!-- 碳排警告 -->
      <el-col :xs="7" :sm="7" :md="12" :lg="12" :xl="12">
        ...
        <dv-border-box-12 class="running-card-box">
          <el-row :gutter="0" style="height:100%;">
            <div class="card-box-power">
              <div class="card-title"><span>各用电类型占比</span></div>
            ...
            <el-row :gutter="0" style="height:80%;">
              ...
              <el-col :span="13">
                <TableSource :tableData="tableRatio" :header="headerRatio" :pStyle="showPage" :total="page.total"></TableSource>
              </el-col>
            </el-row>
          </el-row>
        </dv-border-box-12>
        ...
        <el-row class="pt-10 pl-10 title-fifth" :gutter="15">
          <el-col class="history-card-box-filter" :xs="4" :sm="4" :md="4" :lg="4" :xl="4">
            ...
            <el-radio-group v-model="radioDivisionMode" @change="updateNames">
              ...
              <!-- <el-radio label='electric'>按用电类型</el-radio> -->
            </el-radio-group>
          </el-col>
          <!-- <el-col class="history-card-box-filter" :xs="4" :sm="4" :md="4" :lg="4" :xl="4">
            <span class="opacity-75">数据类型：</span>
            <el-radio-group v-model="radioData">
              <el-radio label="1">用电量</el-radio>
...
export default {
  ...
  methods: {
    ...
    updateCurves: function () {
      // 更新曲线数据
      this.optionCurvesHistory.yAxis[0].name = this.radioData === '2' ? ' ℃' : 'kW·h'
